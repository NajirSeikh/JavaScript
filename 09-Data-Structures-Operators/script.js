...
const restaurant = {
  ...
  orderDelivery({ starterIndex = 1, mainIndex = 0, time = '20:00', address }) {
    console.log(
      `Oder recieved! ${this.starterMenu[starterIndex]} and ${this.mainMenu[mainIndex]} will be delivered to ${address} at ${time}`
    );
  },
...
/* **************String Methods Practice - Dated-20.05.2023************** */
...
/* **************Coding Challenge #4 - Dated-20.05.2023************** */
/* 
...
// const el = '           delayed_               departure';
// console.log(
//   [
//     el.split('_')[0].toLowerCase().trim(),
//     el
//       .split('_')[1]
//       .toLowerCase()
//       .trim()
//       .replace(
//         el.split('_')[1].toLowerCase().trim()[0],
//         el.split('_')[1].toLowerCase().trim()[0].toUpperCase()
//       ),
//   ].join('')
// );
/* 
...
/* **************Working With String-Part 3 - Dated-20.05.2023************** */
/*
// Split() and Slice()
console.log('a+very+nice+string'.split('+'));
console.log('Najir Seikh'.split(' '));

const [firstName, lastName] = 'Najir Seikh'.split(' ');
...
capitalizeName('najir seikh');

// Padding
const message = 'Go to gate 23!';
// console.log(message.padStart(25, '+'));
console.log(message.padStart(20, '+').padEnd(30, '+'));
// console.log('Najir'.padStart(25, '+'));
console.log('Najir'.padStart(20, '+').padEnd(30, '+'));
...
/* **************Working With String-Part 2 - Dated-20.05.2023************** */
/*
...
// Comparing emails
const email = 'hello@najir.io';
const loginEmail = ' Hello@Najir.io';
...
/* **************Maps-Iteration - Dated-20.05.2023************** */
/*
...
/* **************Maps-Fundamentals - Dated-20.05.2023************** */
/*
const rest = new Map();
...
let avgOdds = 0;
for (const oddsValue of totalOdds) {
  avgOdds += oddsValue;
}
avgOdds /= totalOdds.length;
...
/* **************Looping Objects: Objects Keys, Values, and Entries - Dated-20.05.2023************** */
/*
// Property NAMES
...
// Arrays
const users = [{ name: 'Najir', email: 'ns@gmail.com' }];
// const users = [];
...
/* **************Enhanced Object Literals - Dated-19.05.2023************** */
/*
const weekdays = ['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'];
...
// Object passing by Function call
